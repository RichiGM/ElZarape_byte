...
// Selecciona una bebida y llena el formulario
...
// Cambia el estatus de la bebida seleccionada
function cambiarEstatus() {
    if (indexBebidaSeleccionada !== undefined) {
        let bebida = obj[indexBebidaSeleccionada];
        bebida.estatus = (bebida.estatus === "Activo") ? "Baja" : "Activo";
        actualizaTabla();
...
// Agrega una nueva bebida a la lista
function agregarBebida() {
    ...
    if (nombre && descripcion && precio && categoria && foto) {
        let newBebida = {nombre, descripcion, precio, categoria, foto, estatus: "Activo"};
        obj.push(newBebida);
...
// Modifica una bebida existente en la lista
...
// Elimina la bebida seleccionada de la lista
...
// Filtra las bebidas en la tabla según el texto de búsqueda
